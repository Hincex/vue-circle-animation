    ...
    methods: {
        ...
        drawRing() {
            ...
            this.context.arc(
                this.cirX,
                this.cirY,
                this.r - this.context.lineWidth / 2,
                0,
                Math.PI * 2,
                false
            ); //画一个圆的路径
        ...
        drawGradient(n) {
            ...
            // let xPos =
            //     Math.cos(angle) * (this.r - this.ringR / 2) + this.width / 2;
            // let yPos =
            //     -Math.sin(angle) * (this.r - this.ringR / 2) + this.height / 2;
            this.context.save();
        ...
        drawText(n) {
            ...
            this.context.fillText(
                n.toFixed(0),
                this.cirX - this.fontSize / 1.5,
                this.cirY + this.fontSize / 2.5
            ); //绘制数字
            this.context.font = this.fontSize * 0.5 + 'px' + ' Arial';
            this.context.fillText(
                this.unit,
                this.cirX + this.fontSize * 0.5,
                this.cirY + this.fontSize / 3
            ); //绘制单位
            this.context.restore();
        },
        //绘制渐变外圈上的小白圆
